...
print("---Bienvenido administrad@r----")
while True:
    print("")
    print("1. Agregar una pelicula")
    print("2. Listar Peliculas")
    print("3. Agregar un Libro")
    print("4. Listar Lisbros")
    print("5. Ver Productos con poco stock")
    print("6. Salir")
    opcion = input ("Que opcion quieres elegir?:- (1-6) \n").strip()
    print("")
    p = Pelicula()
    l = Libro()
    if int(opcion) == 1:
        print("---Datos de la pelicula---")
        nom = input("Nombre de Pelicula:  \n").strip().capitalize()
        dur = input("Duracion: \n").strip()
        ...
        nom = input("Nombre de libro:  \n").strip().capitalize()
        hojas = int (input("Hojas: \n").strip())
        stock = int (input("Stock: \n").strip())
        ...
        stock = int (input("Cantidad a evaluar? : \n").strip())
